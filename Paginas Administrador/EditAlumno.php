        ...
        <!-- Modal materia -->
                ...
                <div class="container container w-50">
                  <div class="modal-header">
                    <h5 class="modal-title" id="Modalexamen">Editar Alumno</h5>
                  </div>
                  <div class="modal-body ">
                          <form action="Scripts/EditAlumno.php" method="post">
                              <?php
                                include 'Scripts/DBSGE.php';
                                  $conexion = new Database();
                                  $conexion->conectarDB();
                                  $id = $_GET['ID']; 
                                  $cadena = "SELECT * FROM alumnos WHERE Matricula_Alum = $id";
                                ...
                                foreach($reg as $registro)
                                {
                                  ...
                                  <input name='id' value='$registro->Matricula_Alum' type='text' class='form-control' id='exampleFormControlInput1 ' readonly>
                                ...
                                {
                                    echo "<option value='".$value->ID_Status."'>".$value->Estado."</option>";
