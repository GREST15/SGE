        ...
        <!-- Modal materia -->
                ...
                <div class="container container w-50">
                  <div class="modal-header">
                    <h5 class="modal-title" id="Modalexamen">Editar Administrador</h5>
                  </div>
                  <div class="modal-body ">
                            <form action="Scripts/EditAdministrador.php" method="post">
                              <?php
                                include 'Scripts/DBSGE.php';
                                  $conexion = new Database();
                                  $conexion->conectarDB();
                                  $id = $_GET['ID']; 
                                  $cadena = "SELECT * FROM administradores WHERE ID_Admin = $id";
                                ...
                                foreach($reg as $registro)
                                {
                                  ...
                                  <input name='id' value='$registro->ID_Admin' type='text' class='form-control' id='exampleFormControlInput1 ' readonly>
