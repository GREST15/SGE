        ...
        <!-- Modal materia -->
                ...
                <div class="container container w-50">
                  ...
                  <div class="modal-body ">
                            <form action="Scripts/EditarMateria.php" method="post">
                              <?php
                                include 'Scripts/DBSGE.php';
                                  $conexion = new Database();
                                  $conexion->conectarDB();
                                  $id = $_GET['ID']; 
                                  $cadena = "SELECT * FROM materias WHERE ID_Materia= $id";
                                  $reg = $conexion->seleccionar($cadena);
                                  
                                foreach($reg as $registro)
                                {
                                    
                                    $id = $registro->ID_Materia;
                                  ...
                                  echo "<div class=mb-3>
                                  <label for='exampleFormControlInput1' class='form-label'>ID DE MATERIA</label>
                                  <input name='id' value='$id' type='text' class='form-control' id='exampleFormControlInput1 ' readonly>
                                  <label for='exampleFormControlInput1' class='form-label'>Nombre de Materia</label>
                                ...
                                ?> 
                                    ...
                                    <div class="modal-footer">
                                      <button type="submit" class="btn button bggreen">Guardar</button>
                             </form>
                             <a href="RMaterias.php"><button class="btn btn-danger">Cancelar</button></a>
                  </div>
                </div>
                <?php
    }
