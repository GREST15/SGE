...
<head>
	...
	<style>
		.img{width: 40px; padding-left: 15px;}
...
?>
	...
	<footer id="sticky-footer" class="flex-shrink-0 py-4 bggreen text-white-50">
    <div class="container text-center">
      <small>Copyright &copy; Sistema de Gestion Educativa</small> <a href=""><img class="img"  src="img/facebook.png" alt=""> </a><a href=""><img class="img" src="img/gorjeo.png" alt=""> </a><a href=""><img class="img" src="img/whatsapp.png" alt=""></a>
